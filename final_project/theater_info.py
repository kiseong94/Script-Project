...
sub_location_table = {
    "서울특별시": ["전체","도봉구.강북구.성북구.노원구","은평구.서대문구","종로구","마포구","중구.용산구","동대문구.중랑구.성동구.광진구","강서구.양천구.영등포구.구로구","동작구.관악구.금천구","강남구.서초구","강동구.송파구"],
    "인천광역시": ["전체","강화군","서구.계양구.부평구","중구.동구.미추홀구","남동구.연수구.웅진군"],
    "경기도": ["전체","파주시","고양시","양주시.의정부시","남양주시.구리시.가평군","김포시","부천시.광명시","시흥시.안산시","안양시.군포시.의왕시.과천시","수원시","성남시.하남시","용인시","화성시.오산시.평택시","이천시.안성시","광주시.양평군.여주시","연천군.포천시.동두천시"],
    "세종특별자치시": ["전체"],
    "대전광역시": ["전체"],
    "충청도": ["전체","청주시","천안시","당진시","보령시"],
    "강원도": ["전체","원주시"],
    "광주광역시": ["전체"],
    "전라도" : ["전체","전주시","목포시","순천시","여수시"],
    "대구광역시" : ["전체","동구.수성구","중구","북구.서구.달서구"],
    "울산광역시" : ["전체"],
    "부산광역시" : ["전체","해운대구","부산진구","중구.남구","금정구.북구.동래구.연제구"],
    "경상도" : ["전체","구미시","포항시","안동시","창원시","진주시","김해시","거제시.통영시"],
    "제주특별자치도" : ["전체"],
    "" : []
}
...
def getTheaterInfo(location, sub_location):
    ...
    req = urllib.request.Request(GetURL(location,sub_location))
